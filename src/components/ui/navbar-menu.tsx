            ...
            <div className="absolute top-[calc(100%_+_1rem)] left-1/2 transform -translate-x-1/2">
              ...
              >
                <motion.div
                  ...
                  className="w-max h-full p-4 flex flex-col items-center justify-center gap-5"
                >
                  {children}
                </motion.div>
              </motion.div>
...
export const HoveredLink = ({ children, ...rest }: any) => {
  return (
    <Link
      {...rest}
      className="text-neutral-700 dark:text-neutral-200 dark:hover:text-green-700 hover:text-purple-700"
    >
      {children}
    </Link>
  );
